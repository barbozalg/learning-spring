...
docker run --rm --name pg-docker -e POSTGRES_PASSWORD=MyPassword -e POSTGRES_DB=dev -d -p 5432:5432 -v $HOME/docker/volumes/postgres:/var/lib/postgresql postgres
sleep 3
